...
public class VoiceObject extends BaseMediaObject {
    public static final Creator<VoiceObject> CREATOR = new C50461();
    ...
    class C50461 implements Creator<VoiceObject> {
        C50461() {
        }
    ...
    public boolean checkArgs() {
        ...
        if (this.dataUrl != null && this.dataUrl.length() > 512) {
            duj.e("Weibo.VoiceObject", "checkArgs fail, dataUrl is invalid");
            return false;
        } else if (this.dataHdUrl != null && this.dataHdUrl.length() > 512) {
            duj.e("Weibo.VoiceObject", "checkArgs fail, dataHdUrl is invalid");
            return false;
        } else if (this.duration > 0) {
            return true;
        } else {
            duj.e("Weibo.VoiceObject", "checkArgs fail, duration is invalid");
            return false;
        }
    }
