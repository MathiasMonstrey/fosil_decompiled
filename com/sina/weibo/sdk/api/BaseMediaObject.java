...
public abstract class BaseMediaObject implements Parcelable {
    ...
    public final void setThumbImage(Bitmap bitmap) {
        ...
        try {
            ...
            try {
                ...
                try {
                    e.printStackTrace();
                    duj.e("Weibo.BaseMediaObject", "put thumb failed");
                    if (byteArrayOutputStream != null) {
                        try {
                            byteArrayOutputStream.close();
    ...
    protected boolean checkArgs() {
        if (this.actionUrl == null || this.actionUrl.length() > 512) {
            duj.e("Weibo.BaseMediaObject", "checkArgs fail, actionUrl is invalid");
            return false;
        } else if (this.identify == null || this.identify.length() > 512) {
            duj.e("Weibo.BaseMediaObject", "checkArgs fail, identify is invalid");
            return false;
        } else if (this.thumbData == null || this.thumbData.length > 32768) {
            duj.e("Weibo.BaseMediaObject", "checkArgs fail, thumbData is invalid,size is " + (this.thumbData != null ? this.thumbData.length : -1) + "! more then 32768.");
            return false;
        } else if (this.title == null || this.title.length() > 512) {
            duj.e("Weibo.BaseMediaObject", "checkArgs fail, title is invalid");
            return false;
        } else if (this.description != null && this.description.length() <= 1024) {
            return true;
        } else {
            duj.e("Weibo.BaseMediaObject", "checkArgs fail, description is invalid");
            return false;
        }
    }
}
