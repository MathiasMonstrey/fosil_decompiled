...
public class VideoObject extends BaseMediaObject {
    public static final Creator<VideoObject> CREATOR = new C50451();
    ...
    class C50451 implements Creator<VideoObject> {
        C50451() {
        }
    ...
    public boolean checkArgs() {
        ...
        if (this.dataUrl != null && this.dataUrl.length() > 512) {
            duj.e("Weibo.VideoObject", "checkArgs fail, dataUrl is invalid");
            return false;
        } else if (this.dataHdUrl != null && this.dataHdUrl.length() > 512) {
            duj.e("Weibo.VideoObject", "checkArgs fail, dataHdUrl is invalid");
            return false;
        } else if (this.duration > 0) {
            return true;
        } else {
            duj.e("Weibo.VideoObject", "checkArgs fail, duration is invalid");
            return false;
        }
    }
