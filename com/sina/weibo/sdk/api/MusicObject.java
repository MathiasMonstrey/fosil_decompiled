...
public class MusicObject extends BaseMediaObject {
    public static final Creator<MusicObject> CREATOR = new C50431();
    ...
    class C50431 implements Creator<MusicObject> {
        C50431() {
        }
    ...
    public boolean checkArgs() {
        ...
        if (this.dataUrl != null && this.dataUrl.length() > 512) {
            duj.e("Weibo.MusicObject", "checkArgs fail, dataUrl is invalid");
            return false;
        } else if (this.dataHdUrl != null && this.dataHdUrl.length() > 512) {
            duj.e("Weibo.MusicObject", "checkArgs fail, dataHdUrl is invalid");
            return false;
        } else if (this.duration > 0) {
            return true;
        } else {
            duj.e("Weibo.MusicObject", "checkArgs fail, duration is invalid");
            return false;
        }
    }
