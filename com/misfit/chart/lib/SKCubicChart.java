...
public class SKCubicChart extends CubicChart {
    ...
    public SKCubicChart(Context context, AttributeSet attributeSet) {
    ...
    public void XV() {
        ...
        this.bYR.setColor(Color.rgb(203, 210, 217));
