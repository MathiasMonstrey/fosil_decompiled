...
public final class C$Gson$Types {
    ...
    static final class GenericArrayTypeImpl implements Serializable, GenericArrayType {
        ...
        public GenericArrayTypeImpl(Type type) {
            this.componentType = C$Gson$Types.m14576v(type);
        }
    ...
    static final class ParameterizedTypeImpl implements Serializable, ParameterizedType {
        ...
        public ParameterizedTypeImpl(Type type, Type type2, Type... typeArr) {
            ...
            this.ownerType = type == null ? null : C$Gson$Types.m14576v(type);
            this.rawType = C$Gson$Types.m14576v(type2);
            this.typeArguments = (Type[]) typeArr.clone();
            while (i < this.typeArguments.length) {
                cgd.ce(this.typeArguments[i]);
                C$Gson$Types.checkNotPrimitive(this.typeArguments[i]);
                this.typeArguments[i] = C$Gson$Types.m14576v(this.typeArguments[i]);
                i++;
            }
        }
    ...
    static final class WildcardTypeImpl implements Serializable, WildcardType {
        ...
        public WildcardTypeImpl(Type[] typeArr, Type[] typeArr2) {
            ...
            if (typeArr2.length == 1) {
                ...
                cgd.bz(z2);
                this.lowerBound = C$Gson$Types.m14576v(typeArr2[0]);
            ...
            this.upperBound = C$Gson$Types.m14576v(typeArr[0]);
        }
    ...
    public static ParameterizedType m14570a(Type type, Type type2, Type... typeArr) {
        return new ParameterizedTypeImpl(type, type2, typeArr);
    }

    public static GenericArrayType m14575u(Type type) {
        return new GenericArrayTypeImpl(type);
    }

    public static WildcardType m14573o(Type type) {
        return new WildcardTypeImpl(new Type[]{type}, EMPTY_TYPE_ARRAY);
    }

    public static WildcardType m14574p(Type type) {
        return new WildcardTypeImpl(new Type[]{Object.class}, new Type[]{type});
    }

    public static Type m14576v(Type type) {
        if (type instanceof Class) {
            GenericArrayTypeImpl genericArrayTypeImpl;
            Class cls = (Class) type;
            if (cls.isArray()) {
                genericArrayTypeImpl = new GenericArrayTypeImpl(C$Gson$Types.m14576v(cls.getComponentType()));
            } else {
                Object obj = cls;
            }
    ...
    public static Class<?> getRawType(Type type) {
        ...
        if (type instanceof ParameterizedType) {
            ...
            cgd.bz(rawType instanceof Class);
    ...
    public static Type m14571a(Type type, Class<?> cls) {
    ...
    public static Type[] m14572b(Type type, Class<?> cls) {
    ...
    public static Type resolve(Type type, Class<?> cls, Type type2) {
        ...
        if ((type3 instanceof Class) && ((Class) type3).isArray()) {
            ...
            if (componentType != resolve) {
                return C$Gson$Types.m14575u(resolve);
            }
            return cls2;
            ...
            if (i2 != 0) {
                return C$Gson$Types.m14570a(resolve2, parameterizedType.getRawType(), r1);
            }
            ...
            if (r1.length == 1) {
                ...
                if (resolve != r1[0]) {
                    return C$Gson$Types.m14574p(resolve);
                }
                return wildcardType;
            } else if (r4.length != 1) {
                return wildcardType;
                ...
                if (componentType != r4[0]) {
                    return C$Gson$Types.m14573o(componentType);
                }
                return wildcardType;
            }
        }
