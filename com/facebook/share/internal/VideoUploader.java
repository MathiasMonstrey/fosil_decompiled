...
public class VideoUploader {
    ...
    static class C14621 extends AccessTokenTracker {
        C14621() {
        }
    ...
    static abstract class UploadWorkItemBase implements Runnable {
        ...
        private boolean attemptRetry(int i) {
            ...
            VideoUploader.getHandler().postDelayed(new C14661(), (long) (((int) Math.pow(3.0d, (double) this.completedRetries)) * VideoUploader.RETRY_DELAY_UNIT_MS));
            return true;
        }
    ...
    static class FinishUploadWorkItem extends UploadWorkItemBase {
        static final Set<Integer> transientErrorCodes = new C14631();

        static class C14631 extends HashSet<Integer> {
            C14631() {
    ...
    static class StartUploadWorkItem extends UploadWorkItemBase {
        static final Set<Integer> transientErrorCodes = new C14641();

        static class C14641 extends HashSet<Integer> {
            C14641() {
    ...
    static class TransferChunkWorkItem extends UploadWorkItemBase {
        static final Set<Integer> transientErrorCodes = new C14651();
        private String chunkEnd;
        private String chunkStart;

        static class C14651 extends HashSet<Integer> {
            C14651() {
