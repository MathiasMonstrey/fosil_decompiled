...
public class JoinAppGroupDialog extends FacebookDialogBase<String, Result> {
    ...
    protected void registerCallbackImpl(CallbackManagerImpl callbackManagerImpl, final FacebookCallback<Result> facebookCallback) {
        final ResultProcessor c14901 = facebookCallback == null ? null : new ResultProcessor(facebookCallback) {
        ...
        callbackManagerImpl.registerCallback(getRequestCode(), new Callback() {
            public boolean onActivityResult(int i, Intent intent) {
                return ShareInternalUtility.handleActivityResult(JoinAppGroupDialog.this.getRequestCode(), i, intent, c14901);
            }
        });
    }
