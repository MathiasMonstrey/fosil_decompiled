...
public class CreateAppGroupDialog extends FacebookDialogBase<AppGroupCreationContent, Result> {
    ...
    protected void registerCallbackImpl(CallbackManagerImpl callbackManagerImpl, final FacebookCallback<Result> facebookCallback) {
        final ResultProcessor c14851 = facebookCallback == null ? null : new ResultProcessor(facebookCallback) {
        ...
        callbackManagerImpl.registerCallback(getRequestCode(), new Callback() {
            public boolean onActivityResult(int i, Intent intent) {
                return ShareInternalUtility.handleActivityResult(CreateAppGroupDialog.this.getRequestCode(), i, intent, c14851);
            }
        });
    }
