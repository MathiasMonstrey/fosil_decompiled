...
public class LoginFragment extends Fragment {
    ...
    class C14031 implements OnCompletedListener {
        C14031() {
        }
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.loginClient.setOnCompletedListener(new C14031());
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        final View inflate = layoutInflater.inflate(C1325R.layout.com_facebook_login_fragment, viewGroup, false);
        this.loginClient.setBackgroundProcessingListener(new BackgroundProcessingListener() {
            public void onBackgroundProcessingStarted() {
                inflate.findViewById(C1325R.id.com_facebook_login_activity_progress_bar).setVisibility(0);
            }

            public void onBackgroundProcessingStopped() {
                inflate.findViewById(C1325R.id.com_facebook_login_activity_progress_bar).setVisibility(8);
            }
        });
        return inflate;
    }
    ...
    public void onPause() {
        super.onPause();
        getActivity().findViewById(C1325R.id.com_facebook_login_activity_progress_bar).setVisibility(8);
    }
