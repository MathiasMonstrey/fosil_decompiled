...
public class ProfilePictureView extends FrameLayout {
    ...
    private void parseAttributes(AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C1325R.styleable.com_facebook_profile_picture_view);
        setPresetSize(obtainStyledAttributes.getInt(C1325R.styleable.com_facebook_profile_picture_view_com_facebook_preset_size, -1));
        this.isCropped = obtainStyledAttributes.getBoolean(C1325R.styleable.com_facebook_profile_picture_view_com_facebook_is_cropped, true);
    ...
    private void setBlankProfilePicture() {
        ...
        if (this.customizedDefaultProfilePicture == null) {
            setImageBitmap(BitmapFactory.decodeResource(getResources(), isCropped() ? C1325R.drawable.com_facebook_profile_picture_blank_square : C1325R.drawable.com_facebook_profile_picture_blank_portrait));
            return;
        }
    ...
    private void sendImageRequest(boolean z) {
        ImageRequest build = new Builder(getContext(), ImageRequest.getProfilePictureUri(this.profileId, this.queryWidth, this.queryHeight)).setAllowCachedRedirects(z).setCallerTag(this).setCallback(new C14161()).build();
        if (this.lastRequest != null) {
            ImageDownloader.cancelRequest(this.lastRequest);
        }
    ...
    private int getPresetSizeInPixels(boolean z) {
        ...
        switch (this.presetSizeType) {
            case LARGE /*-4*/:
                i = C1325R.dimen.com_facebook_profilepictureview_preset_size_large;
                break;
            case NORMAL /*-3*/:
                i = C1325R.dimen.com_facebook_profilepictureview_preset_size_normal;
                break;
            case -2:
                i = C1325R.dimen.com_facebook_profilepictureview_preset_size_small;
                break;
            case -1:
                if (z) {
                    i = C1325R.dimen.com_facebook_profilepictureview_preset_size_normal;
