...
public class MFGetRecommendedPresetsResponse extends MFResponse {
                ...
                if (jSONArray.length() > 0) {
                    for (int i = 0; i < jSONArray.length(); i++) {
                        ...
                        if (jSONObject2.has("name")) {
                            recommendedPreset.setName(jSONObject2.getString("name"));
                        }
                        ...
                        if (jSONObject2.has("createAt")) {
                            recommendedPreset.setCreateAt(ISODateTimeFormat.dateTimeNoMillis().parseDateTime(jSONObject2.getString("createAt")).getMillis());
                        }
                        ...
                        recommendedPreset.setType(SavedPreset$MappingSetType.RECOMMENDED);
    ...
    public void setRecommendedPresets(List<RecommendedPreset> list) {
        this.recommendedPresets = list;
    }
