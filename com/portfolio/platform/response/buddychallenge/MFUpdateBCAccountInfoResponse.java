...
public class MFUpdateBCAccountInfoResponse extends MFResponse {
        ...
        if (httpReturnCode == MFNetworkReturnCode.RESPONSE_OK || httpReturnCode == 201) {
            ...
            try {
                if (jSONObject.has("_error")) {
                    ...
                    MFLogger.e("MFUpdateBCAccountInfoResponse", "Error " + httpReturnCode + " without internal error code");
                }
            } catch (JSONException e) {
                MFLogger.e("MFUpdateBCAccountInfoResponse", "Error when handle result" + e.toString());
            }
        }
    }
}
