...
public class DatabaseFieldConfig {
    ...
    public static Method findGetMethod(Field field, boolean z) throws IllegalArgumentException {
        ...
        if (Locale.ENGLISH.equals(Locale.getDefault())) {
            findMethodFromNames = findMethodFromNames(field, true, z, methodFromField(field, "get", null), methodFromField(field, "is", null));
        } else {
            findMethodFromNames = findMethodFromNames(field, true, z, methodFromField(field, "get", null), methodFromField(field, "get", Locale.ENGLISH), methodFromField(field, "is", null), methodFromField(field, "is", Locale.ENGLISH));
        }
    ...
    public static Method findSetMethod(Field field, boolean z) throws IllegalArgumentException {
        Method findMethodFromNames;
        if (Locale.ENGLISH.equals(Locale.getDefault())) {
            findMethodFromNames = findMethodFromNames(field, false, z, methodFromField(field, "set", null));
        } else {
            findMethodFromNames = findMethodFromNames(field, false, z, methodFromField(field, "set", null), methodFromField(field, "set", Locale.ENGLISH));
        }
        if (findMethodFromNames == null) {
            return null;
        }
    ...
    private static Method findMethodFromNames(Field field, boolean z, boolean z2, String... strArr) {
        ...
        throw new IllegalArgumentException("Could not find appropriate " + (z ? "get" : "set") + " method for " + field, th);
    }
    ...
    private static String methodFromField(Field field, String str, Locale locale) {
        ...
        stringBuilder.append(name, 1, name.length());
