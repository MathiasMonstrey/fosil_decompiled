...
public final class AnnotatedConstructor extends AnnotatedWithParams {
    ...
    public AnnotatedConstructor(air com_fossil_air, Constructor<?> constructor, ait com_fossil_ait, ait[] com_fossil_aitArr) {
    ...
    public AnnotatedConstructor withAnnotations(ait com_fossil_ait) {
        return new AnnotatedConstructor(this._context, this._constructor, com_fossil_ait, this._paramAnnotations);
    }
    ...
    public JavaType getType(ama com_fossil_ama) {
        return getType(com_fossil_ama, this._constructor.getTypeParameters());
    }
    ...
    Object readResolve() {
        ...
        try {
            ...
            if (!declaredConstructor.isAccessible()) {
                ami.m3862a(declaredConstructor);
            }
