...
public class BeanPropertyMap implements Serializable, Iterable<SettableBeanProperty> {
    ...
    public BeanPropertyMap withProperty(SettableBeanProperty settableBeanProperty) {
        ...
        for (i = 1; i < length; i += 2) {
            ...
            if (settableBeanProperty2 != null && settableBeanProperty2.getName().equals(propertyName)) {
                ...
                this._propsInOrder[m2705c(settableBeanProperty2)] = settableBeanProperty;
                break;
            }
        }
        i = bH(propertyName);
    ...
    public BeanPropertyMap renameAll(amo com_fossil_amo) {
        if (com_fossil_amo == null || com_fossil_amo == amo.aVN) {
            return this;
        }
        ...
        for (SettableBeanProperty settableBeanProperty : this._propsInOrder) {
            if (settableBeanProperty == null) {
                ...
                arrayList.add(_rename(settableBeanProperty, com_fossil_amo));
            }
        }
    ...
    private List<SettableBeanProperty> Ey() {
    ...
    public SettableBeanProperty find(String str) {
        ...
        return m2704a(str, hashCode, str2);
    }

    private final SettableBeanProperty m2704a(String str, int i, Object obj) {
        if (obj == null) {
            return null;
        }
        ...
        for (int i = 1; i < length; i += 2) {
            ...
            if (settableBeanProperty2 != null) {
                if (!z) {
                    ...
                    if (z) {
                        this._propsInOrder[m2705c(settableBeanProperty2)] = null;
                    }
                }
    ...
    protected SettableBeanProperty _rename(SettableBeanProperty settableBeanProperty, amo com_fossil_amo) {
        if (settableBeanProperty == null) {
            return settableBeanProperty;
        }
        SettableBeanProperty withSimpleName = settableBeanProperty.withSimpleName(com_fossil_amo.cc(settableBeanProperty.getName()));
    ...
    private int m2705c(SettableBeanProperty settableBeanProperty) {
