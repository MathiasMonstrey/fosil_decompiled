...
public final class ObjectIdValueProperty extends SettableBeanProperty {
    ...
    protected ObjectIdValueProperty(ObjectIdValueProperty objectIdValueProperty, agy<?> com_fossil_agy_) {
        super((SettableBeanProperty) objectIdValueProperty, (agy) com_fossil_agy_);
    ...
    public ObjectIdValueProperty withValueDeserializer(agy<?> com_fossil_agy_) {
        return new ObjectIdValueProperty(this, (agy) com_fossil_agy_);
    }
    ...
    public Object deserializeSetAndReturn(JsonParser jsonParser, DeserializationContext deserializationContext, Object obj) throws IOException {
        ...
        deserializationContext.findObjectId(deserialize, this._objectIdReader.generator, this._objectIdReader.resolver).bu(obj);
