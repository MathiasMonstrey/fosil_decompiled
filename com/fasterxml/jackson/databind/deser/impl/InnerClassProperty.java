...
public final class InnerClassProperty extends SettableBeanProperty {
    ...
    protected InnerClassProperty(InnerClassProperty innerClassProperty, agy<?> com_fossil_agy_) {
        super((SettableBeanProperty) innerClassProperty, (agy) com_fossil_agy_);
        this._delegate = innerClassProperty._delegate.withValueDeserializer(com_fossil_agy_);
    ...
    public InnerClassProperty withValueDeserializer(agy<?> com_fossil_agy_) {
        return new InnerClassProperty(this, (agy) com_fossil_agy_);
    }
    ...
    public void deserializeAndSet(JsonParser jsonParser, DeserializationContext deserializationContext, Object obj) throws IOException {
        ...
        if (jsonParser.zU() == JsonToken.VALUE_NULL) {
            ...
            try {
                ...
                ami.m3867c(e, "Failed to instantiate class " + this._creator.getDeclaringClass().getName() + ", problem: " + e.getMessage());
                nullValue = null;
            }
