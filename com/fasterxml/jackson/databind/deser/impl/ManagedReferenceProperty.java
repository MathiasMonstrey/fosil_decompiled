...
public final class ManagedReferenceProperty extends SettableBeanProperty {
    ...
    public ManagedReferenceProperty(SettableBeanProperty settableBeanProperty, String str, SettableBeanProperty settableBeanProperty2, amc com_fossil_amc, boolean z) {
        super(settableBeanProperty.getFullName(), settableBeanProperty.getType(), settableBeanProperty.getWrapperName(), settableBeanProperty.getValueTypeDeserializer(), com_fossil_amc, settableBeanProperty.getMetadata());
    ...
    protected ManagedReferenceProperty(ManagedReferenceProperty managedReferenceProperty, agy<?> com_fossil_agy_) {
        super((SettableBeanProperty) managedReferenceProperty, (agy) com_fossil_agy_);
    ...
    public ManagedReferenceProperty withValueDeserializer(agy<?> com_fossil_agy_) {
        return new ManagedReferenceProperty(this, (agy) com_fossil_agy_);
    }
