...
public class ThrowableDeserializer extends BeanDeserializer {
    ...
    protected ThrowableDeserializer(BeanDeserializer beanDeserializer, amo com_fossil_amo) {
        super((BeanDeserializerBase) beanDeserializer, com_fossil_amo);
    }

    public agy<Object> unwrappingDeserializer(amo com_fossil_amo) {
        return getClass() != ThrowableDeserializer.class ? this : new ThrowableDeserializer(this, com_fossil_amo);
    }
    ...
    public Object deserializeFromObject(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
        ...
        if (canCreateFromString || canCreateUsingDefault) {
            ...
            while (jsonParser.zU() != JsonToken.END_OBJECT) {
                ...
                jsonParser.zP();
                if (find == null) {
                    if ("message".equals(zW) && canCreateFromString) {
