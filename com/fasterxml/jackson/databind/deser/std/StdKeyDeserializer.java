...
@ahh
public class StdKeyDeserializer extends ahc implements Serializable {
    ...
    static final class DelegatingKD extends ahc implements Serializable {
        private static final long serialVersionUID = 1;
        protected final agy<?> _delegate;
        protected final Class<?> _keyClass;

        protected DelegatingKD(Class<?> cls, agy<?> com_fossil_agy_) {
            this._keyClass = cls;
            this._delegate = com_fossil_agy_;
        }
    ...
    static final class StringKD extends StdKeyDeserializer {
        private static final StringKD aSj = new StringKD(String.class);
        private static final StringKD aSk = new StringKD(Object.class);
        private static final long serialVersionUID = 1;
