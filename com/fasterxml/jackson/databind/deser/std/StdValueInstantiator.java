...
@ahh
public class StdValueInstantiator extends aie implements Serializable {
    ...
    public Object createUsingDelegate(DeserializationContext deserializationContext, Object obj) throws IOException {
        ...
        try {
            ...
            for (int i = 0; i < length; i++) {
                agv com_fossil_agv = this._delegateArguments[i];
                if (com_fossil_agv == null) {
                    objArr[i] = obj;
                } else {
                    objArr[i] = deserializationContext.findInjectableValue(com_fossil_agv.getInjectableValueId(), com_fossil_agv, null);
                }
            }
