...
public abstract class MapperConfigBase<CFG extends ahq, T extends MapperConfigBase<CFG, T>> extends MapperConfig<T> implements Serializable {
    private static final int aQH = MapperConfig.collectFeatureDefaults(MapperFeature.class);
    protected final ContextAttributes _attributes;
    protected final SimpleMixInResolver _mixIns;
    protected final PropertyName _rootName;
    protected final RootNameLookup _rootNames;
    protected final ajr _subtypeResolver;
    ...
    public abstract T with(ahr com_fossil_ahr);

    public abstract T with(aiw com_fossil_aiw);

    public abstract T with(ajr com_fossil_ajr);

    public abstract T with(aju<?> com_fossil_aju_);
    ...
    protected MapperConfigBase(BaseSettings baseSettings, ajr com_fossil_ajr, SimpleMixInResolver simpleMixInResolver, RootNameLookup rootNameLookup) {
        super(baseSettings, aQH);
    ...
    protected MapperConfigBase(MapperConfigBase<CFG, T> mapperConfigBase, ajr com_fossil_ajr) {
        super(mapperConfigBase);
        this._mixIns = mapperConfigBase._mixIns;
        this._subtypeResolver = com_fossil_ajr;
        this._rootNames = mapperConfigBase._rootNames;
    ...
    public final ajr getSubtypeResolver() {
