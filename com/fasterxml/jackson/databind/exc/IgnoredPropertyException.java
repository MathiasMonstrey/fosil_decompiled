...
public class IgnoredPropertyException extends PropertyBindingException {
    ...
    public static IgnoredPropertyException from(JsonParser jsonParser, Object obj, String str, Collection<Object> collection) {
        ...
        IgnoredPropertyException ignoredPropertyException = new IgnoredPropertyException("Ignored field \"" + str + "\" (class " + cls.getName() + ") encountered; mapper configured not to allow this", jsonParser.zZ(), cls, str, collection);
