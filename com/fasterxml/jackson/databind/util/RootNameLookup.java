...
public class RootNameLookup implements Serializable {
    ...
    protected transient LRUMap<ClassKey, PropertyName> _rootNames = new LRUMap(20, MFNetworkReturnCode.RESPONSE_OK);
    ...
    public PropertyName findRootName(Class<?> cls, MapperConfig<?> mapperConfig) {
        ...
        if (propertyName == null) {
            propertyName = mapperConfig.getAnnotationIntrospector().findRootName(mapperConfig.introspectClassAnnotations((Class) cls).Dn());
