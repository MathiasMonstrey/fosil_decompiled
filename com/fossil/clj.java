...
public class clj extends C2161i {
    ...
    public clj(C2160d c2160d, View view) {
        super(c2160d, view, 0);
    ...
    public static clj m7028v(View view, C2160d c2160d) {
        if ("layout/stats_activity_month_fragment_0".equals(view.getTag())) {
            return new clj(c2160d, view);
        }
