...
public class cbr {
    ...
    private static boolean m5950a(PackageInfo packageInfo, byte[]... bArr) {
    ...
    public static cbr aW(Context context) {
        awa.bO(context);
    ...
    private static boolean m5951c(PackageInfo packageInfo, boolean z) {
        if (packageInfo.signatures.length != 1) {
            Log.w("WearSignatureVerifier", "Package has more than one signature.");
            return false;
        }
        ...
        if (z) {
            return m5950a(packageInfo, bLd, bLe);
        }
        return m5950a(packageInfo, bLd);
    }
    ...
    private final PackageInfo fb(String str) {
        try {
            return bje.aQ(this.mContext).getPackageInfo(str, 64);
    ...
    public final boolean fa(String str) {
        PackageInfo fb = fb(str);
        if (fb == null) {
            return false;
        }
        if (ayo.az(this.mContext)) {
            return m5951c(fb, true);
        }
        boolean c = m5951c(fb, false);
        if (c || !m5951c(fb, true)) {
            return c;
        }
