...
public class clk extends C2161i {
    ...
    public final FlexibleTextView cvd;
    ...
    static {
        ...
        cpH.put(R.id.v_moderate, 3);
        cpH.put(R.id.v_light, 4);
        cpH.put(R.id.ftv_intense, 5);
        cpH.put(R.id.ftv_moderate, 6);
        cpH.put(R.id.ftv_light, 7);
    }

    public clk(C2160d c2160d, View view) {
        super(c2160d, view, 0);
    ...
    public static clk m7029w(View view, C2160d c2160d) {
        if ("layout/stats_activity_overview_fragment_0".equals(view.getTag())) {
            return new clk(c2160d, view);
        }
