...
public class cln extends C2161i {
    ...
    public cln(C2160d c2160d, View view) {
        super(c2160d, view, 0);
    ...
    public static cln m7032z(View view, C2160d c2160d) {
        if ("layout/stats_sleep_day_fragment_0".equals(view.getTag())) {
            return new cln(c2160d, view);
        }
