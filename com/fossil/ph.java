...
class ph {
    ...
    public void m13056a(long j, double d, double d2) {
        ...
        if (sin >= 1.0d) {
            ...
            this.adb = Math.round((((double) acos) + sin2) * 8.64E7d) + 946728000000L;
            this.adc = Math.round((sin2 - ((double) acos)) * 8.64E7d) + 946728000000L;
            if (this.adc >= j || this.adb <= j) {
                this.state = 1;
            } else {
                this.state = 0;
            }
