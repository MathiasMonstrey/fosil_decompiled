...
public class cll extends C2161i {
    ...
    public cll(C2160d c2160d, View view) {
        super(c2160d, view, 0);
    ...
    public static cll m7030x(View view, C2160d c2160d) {
        if ("layout/stats_activity_week_fragment_0".equals(view.getTag())) {
            return new cll(c2160d, view);
        }
