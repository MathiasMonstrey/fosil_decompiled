...
public final class etg {
    ...
    public static String encode(byte[] bArr) {
        return m11148e(bArr, dTe);
    }

    public static String aw(byte[] bArr) {
        return m11148e(bArr, dTf);
    }

    private static String m11148e(byte[] bArr, byte[] bArr2) {
        int i = 0;
