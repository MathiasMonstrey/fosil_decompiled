...
public class ev extends Fragment implements OnCancelListener, OnDismissListener {
    ...
    public int show(fg fgVar, String str) {
        this.mDismissed = false;
        this.mShownByMe = true;
        fgVar.mo2968a((Fragment) this, str);
        this.mViewDestroyed = false;
        this.mBackStackId = fgVar.commit();
