...
public final class bop extends bqi {
    public bop(bpk com_fossil_bpk) {
        super(com_fossil_bpk);
    }

    private static byte[] m5442b(HttpURLConnection httpURLConnection) throws IOException {
    ...
    public final void m5443a(String str, URL url, Map<String, String> map, bor com_fossil_bor) {
        super.OP();
        RA();
        awa.bO(url);
        awa.bO(com_fossil_bor);
        super.Pe().m5470i(new bot(this, str, url, null, map, com_fossil_bor));
    }

    public final void m5444a(String str, URL url, byte[] bArr, Map<String, String> map, bor com_fossil_bor) {
        super.OP();
        RA();
        awa.bO(url);
        awa.bO(bArr);
        awa.bO(com_fossil_bor);
        super.Pe().m5470i(new bot(this, str, url, bArr, null, com_fossil_bor));
    }
