...
class by {
    ...
    public static class C1971b {
        char DY;
        float[] DZ;

        C1971b(char c, float[] fArr) {
            this.DY = c;
            this.DZ = fArr;
        }

        C1971b(C1971b c1971b) {
            this.DY = c1971b.DY;
            this.DZ = by.copyOfRange(c1971b.DZ, 0, c1971b.DZ.length);
        }

        public static void m5782a(C1971b[] c1971bArr, Path path) {
            float[] fArr = new float[6];
            char c = 'm';
            for (int i = 0; i < c1971bArr.length; i++) {
                C1971b.m5781a(path, fArr, c, c1971bArr[i].DY, c1971bArr[i].DZ);
                c = c1971bArr[i].DY;
            }
        }

        public void m5783a(C1971b c1971b, C1971b c1971b2, float f) {
            for (int i = 0; i < c1971b.DZ.length; i++) {
                this.DZ[i] = (c1971b.DZ[i] * (1.0f - f)) + (c1971b2.DZ[i] * f);
            }
        }

        private static void m5781a(Path path, float[] fArr, char c, char c2, float[] fArr2) {
            int i;
            float f = fArr[0];
            float f2 = fArr[1];
            float f3 = fArr[2];
            ...
            while (i2 < fArr2.length) {
                ...
                switch (c2) {
                    case 'A':
                        ...
                        C1971b.m5780a(path, f10, f9, f5, f2, f, f11, f12, z, z2);
                        f3 = fArr2[i2 + 5];
                        f4 = fArr2[i2 + 6];
                        f6 = f7;
                        f5 = f8;
        ...
        private static void m5780a(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
            ...
            if (d10 < 0.0d) {
                ...
                C1971b.m5780a(path, f, f2, f3, f4, f5 * sqrt, f6 * sqrt, f7, z, z2);
                return;
            }
            d9 = Math.sqrt(d10);
            d5 *= d9;
            ...
            d = ((double) f5) * d6;
            d5 *= (double) f6;
            C1971b.m5779a(path, (d * cos) - (d5 * sin), (d * sin) + (d5 * cos), (double) f5, (double) f6, (double) f, (double) f2, toRadians, d7, d4);
        }

        private static void m5779a(Path path, double d, double d2, double d3, double d4, double d5, double d6, double d7, double d8, double d9) {
    ...
    public static Path m5784O(String str) {
        Path path = new Path();
        C1971b[] P = m5785P(str);
        if (P == null) {
            return null;
    ...
    public static C1971b[] m5785P(String str) {
        if (str == null) {
            return null;
        }
        ...
        while (i < str.length()) {
            ...
            if (trim.length() > 0) {
                m5788a(arrayList, trim.charAt(0), m5786Q(trim));
            }
            i = d + 1;
            i2 = d;
        }
        if (i - i2 == 1 && i2 < str.length()) {
            m5788a(arrayList, str.charAt(i2), new float[0]);
        }
        return (C1971b[]) arrayList.toArray(new C1971b[arrayList.size()]);
    }

    public static C1971b[] m5790a(C1971b[] c1971bArr) {
        if (c1971bArr == null) {
            return null;
        }
        C1971b[] c1971bArr2 = new C1971b[c1971bArr.length];
        for (int i = 0; i < c1971bArr.length; i++) {
            c1971bArr2[i] = new C1971b(c1971bArr[i]);
        }
        return c1971bArr2;
    }

    public static boolean m5789a(C1971b[] c1971bArr, C1971b[] c1971bArr2) {
        if (c1971bArr == null || c1971bArr2 == null || c1971bArr.length != c1971bArr2.length) {
            return false;
        }
        int i = 0;
        while (i < c1971bArr.length) {
            if (c1971bArr[i].DY != c1971bArr2[i].DY || c1971bArr[i].DZ.length != c1971bArr2[i].DZ.length) {
                return false;
            }
            i++;
        }
    ...
    public static void m5791b(C1971b[] c1971bArr, C1971b[] c1971bArr2) {
        for (int i = 0; i < c1971bArr2.length; i++) {
            c1971bArr[i].DY = c1971bArr2[i].DY;
            for (int i2 = 0; i2 < c1971bArr2[i].DZ.length; i2++) {
                c1971bArr[i].DZ[i2] = c1971bArr2[i].DZ[i2];
            }
        }
    }

    private static int m5792d(String str, int i) {
        while (i < str.length()) {
    ...
    private static void m5788a(ArrayList<C1971b> arrayList, char c, float[] fArr) {
        arrayList.add(new C1971b(c, fArr));
    }

    private static float[] m5786Q(String str) {
    ...
    private static void m5787a(java.lang.String r7, int r8, com.fossil.by.C1970a r9) {
        /*
        r1 = 0;
        r5 = 1;
        r9.DX = r1;
    ...
    L_0x0033:
        ...
        goto L_0x0008;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fossil.by.a(java.lang.String, int, com.fossil.by$a):void");
    }
}
