...
class fw {
    ...
    public static class C3607a implements fp {
        private Builder LS;

        public C3607a(Context context, Notification notification, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, RemoteViews remoteViews, int i, PendingIntent pendingIntent, PendingIntent pendingIntent2, Bitmap bitmap, int i2, int i3, boolean z) {
        ...
        public Notification build() {
            return this.LS.getNotification();
        }
    }
}
