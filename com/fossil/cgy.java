...
public class cgy {
    public static Map<Integer, List<String>> Xw() {
        ...
        arrayList = new ArrayList(1);
        arrayList.add(DeviceIdentityUtils.SWAROVSKI_SERIAL_NUMBER_PREFIX);
        ...
        arrayList = new ArrayList(1);
        arrayList.add("GL");
        hashMap.put(Integer.valueOf(Selfie.SELFIE_END_ACTION), arrayList);
        arrayList = new ArrayList(1);
        arrayList.add("GI");
        ...
        arrayList = new ArrayList(1);
        arrayList.add("FK");
        hashMap.put(Integer.valueOf(MFNetworkReturnCode.INTERNAL_SERVER_ERROR), arrayList);
        arrayList = new ArrayList(1);
        arrayList.add("BZ");
        hashMap.put(Integer.valueOf(Apps.BOLT), arrayList);
        arrayList = new ArrayList(1);
        arrayList.add("GT");
        hashMap.put(Integer.valueOf(Apps.IF), arrayList);
        arrayList = new ArrayList(1);
        arrayList.add("SV");
        ...
        arrayList = new ArrayList(1);
        arrayList.add("NI");
        hashMap.put(Integer.valueOf(Apps.RING_MY_PHONE), arrayList);
        arrayList = new ArrayList(1);
        arrayList.add("CR");
