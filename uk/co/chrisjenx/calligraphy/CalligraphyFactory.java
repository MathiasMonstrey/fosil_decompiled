...
class CalligraphyFactory {
    ...
    static class ToolbarLayoutListener implements OnGlobalLayoutListener {
        static String BLANK = MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR;
    ...
    public View onViewCreated(View view, Context context, AttributeSet attributeSet) {
        if (!(view == null || view.getTag(C5213R.id.calligraphy_tag_id) == Boolean.TRUE)) {
            onViewCreatedInternal(view, context, attributeSet);
            view.setTag(C5213R.id.calligraphy_tag_id, Boolean.TRUE);
        }
        return view;
    }
