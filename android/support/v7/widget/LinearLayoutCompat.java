...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            this.weight = obtainStyledAttributes.getFloat(j.LinearLayoutCompat_Layout_android_layout_weight, 0.0f);
            this.gravity = obtainStyledAttributes.getInt(j.LinearLayoutCompat_Layout_android_layout_gravity, -1);
    ...
    public LinearLayoutCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        sw a = sw.a(context, attributeSet, j.LinearLayoutCompat, i, 0);
        int i2 = a.getInt(j.LinearLayoutCompat_android_orientation, -1);
        if (i2 >= 0) {
            setOrientation(i2);
        }
        i2 = a.getInt(j.LinearLayoutCompat_android_gravity, -1);
        if (i2 >= 0) {
            setGravity(i2);
        }
        boolean z = a.getBoolean(j.LinearLayoutCompat_android_baselineAligned, true);
        if (!z) {
            setBaselineAligned(z);
        }
        this.mWeightSum = a.getFloat(j.LinearLayoutCompat_android_weightSum, -1.0f);
        this.mBaselineAlignedChildIndex = a.getInt(j.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
        this.mUseLargestChild = a.getBoolean(j.LinearLayoutCompat_measureWithLargestChild, false);
        setDividerDrawable(a.getDrawable(j.LinearLayoutCompat_divider));
        this.mShowDividers = a.getInt(j.LinearLayoutCompat_showDividers, 0);
        this.mDividerPadding = a.getDimensionPixelSize(j.LinearLayoutCompat_dividerPadding, 0);
        a.recycle();
    }
    ...
    void measureVertical(int i, int i2) {
        ...
        while (i12 < virtualChildCount) {
            ...
            if (virtualChildAt2 == null) {
                ...
                if (i12 >= i10 || layoutParams.weight <= 0.0f) {
                    ...
                    i6 = Math.max(i6, i13);
                    int combineMeasuredStates = tb.combineMeasuredStates(i7, li.m12239W(virtualChildAt2));
        ...
        int resolveSizeAndState = li.resolveSizeAndState(Math.max(this.mTotalLength, getSuggestedMinimumHeight()), i2, 0);
            ...
            while (i11 < virtualChildCount) {
                ...
                if (virtualChildAt3.getVisibility() == 8) {
                    ...
                    if (f6 > 0.0f) {
                        ...
                        f4 = f3;
                        i12 = i15;
                        i15 = tb.combineMeasuredStates(i16, li.m12239W(virtualChildAt3) & -256);
                        f5 = f4;
                    } else {
                        f5 = f3;
                        i12 = i15;
        ...
        setMeasuredDimension(li.resolveSizeAndState(Math.max(i3 + (getPaddingLeft() + getPaddingRight()), getSuggestedMinimumWidth()), i, i7), resolveSizeAndState);
        if (obj3 != null) {
    ...
    void measureHorizontal(int i, int i2) {
        ...
        while (i12 < virtualChildCount) {
            ...
            if (virtualChildAt == null) {
                ...
                if (mode == 1073741824 && layoutParams2.width == 0 && layoutParams2.weight > 0.0f) {
                    ...
                    int i13 = i3;
                    measureChildBeforeLayout(virtualChildAt, i12, i, f2 == 0.0f ? this.mTotalLength : 0, i2, 0);
                ...
                int combineMeasuredStates = tb.combineMeasuredStates(i8, li.m12239W(virtualChildAt));
                if (z) {
        ...
        if (z2 && (mode == Integer.MIN_VALUE || mode == 0)) {
            ...
            while (i6 < virtualChildCount) {
                ...
                if (virtualChildAt2 == null) {
                    ...
                    layoutParams = (LayoutParams) virtualChildAt2.getLayoutParams();
                    if (obj != null) {
                        this.mTotalLength = ((layoutParams.rightMargin + (layoutParams.leftMargin + i11)) + getNextLocationOffset(virtualChildAt2)) + this.mTotalLength;
                        i3 = i6;
                    } else {
                        i4 = this.mTotalLength;
                        this.mTotalLength = Math.max(i4, (layoutParams.rightMargin + ((i4 + i11) + layoutParams.leftMargin)) + getNextLocationOffset(virtualChildAt2));
                        i3 = i6;
                    }
                }
                i6 = i3 + 1;
        ...
        int resolveSizeAndState = li.resolveSizeAndState(Math.max(this.mTotalLength, getSuggestedMinimumWidth()), i, 0);
        i6 = (16777215 & resolveSizeAndState) - this.mTotalLength;
        int i16;
                ...
                if (virtualChildAt3 == null) {
                    ...
                    if (f6 > 0.0f) {
                        ...
                        if (layoutParams.width == 0 && mode == 1073741824) {
                            ...
                            virtualChildAt3.measure(MeasureSpec.makeMeasureSpec(i6, 1073741824), i14);
                        } else {
                        ...
                        i10 = tb.combineMeasuredStates(i15, li.m12239W(virtualChildAt3) & -16777216);
                        f5 = f3;
                    } else {
                        i4 = i14;
                        i10 = i15;
                    ...
                    i14 = virtualChildAt3.getMeasuredHeight() + i12;
                    i9 = Math.max(i9, i14);
                    if (obj5 != null) {
                        i6 = i12;
                    } else {
            ...
            if (z2 && mode != 1073741824) {
                for (i6 = 0; i6 < virtualChildCount; i6++) {
                    ...
                    if (!(virtualChildAt4 == null || virtualChildAt4.getVisibility() == 8 || ((LayoutParams) virtualChildAt4.getLayoutParams()).weight <= 0.0f)) {
                        virtualChildAt4.measure(MeasureSpec.makeMeasureSpec(i11, 1073741824), MeasureSpec.makeMeasureSpec(virtualChildAt4.getMeasuredHeight(), 1073741824));
                    }
                }
            }
            i3 = i16;
        ...
        setMeasuredDimension((-16777216 & i8) | resolveSizeAndState, li.resolveSizeAndState(Math.max(i3 + (getPaddingTop() + getPaddingBottom()), getSuggestedMinimumHeight()), i2, i8 << 16));
        if (obj3 != null) {
    ...
    void layoutVertical(int i, int i2, int i3, int i4) {
        ...
        while (i7 < virtualChildCount) {
            ...
            if (virtualChildAt == null) {
                ...
                switch (ke.getAbsoluteGravity(i5, li.m12235S(this)) & 7) {
                    case 1:
    ...
    void layoutHorizontal(int i, int i2, int i3, int i4) {
        ...
        int[] iArr = this.mMaxAscent;
        int[] iArr2 = this.mMaxDescent;
        switch (ke.getAbsoluteGravity(i7, li.m12235S(this))) {
            case 1:
