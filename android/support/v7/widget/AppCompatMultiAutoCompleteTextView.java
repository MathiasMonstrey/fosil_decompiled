...
public class AppCompatMultiAutoCompleteTextView extends MultiAutoCompleteTextView implements lf {
    private static final int[] afU = new int[]{16843126};
    ...
    public void setDropDownBackgroundResource(int i) {
        setDropDownBackgroundDrawable(pn.c(getContext(), i));
    }
