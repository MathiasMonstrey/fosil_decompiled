...
public class ContentFrameLayout extends FrameLayout {
    ...
    private TypedValue alV;
    private TypedValue alW;
    private TypedValue alX;
    private TypedValue alY;
    private TypedValue alZ;
    ...
    public void m2220i(Rect rect) {
        fitSystemWindows(rect);
    }

    public void setAttachListener(C1218a c1218a) {
        this.amb = c1218a;
    }

    public void m2221l(int i, int i2, int i3, int i4) {
        this.ama.set(i, i2, i3, i4);
        if (li.as(this)) {
            requestLayout();
        }
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (mode == Integer.MIN_VALUE) {
            typedValue = obj3 != null ? this.alX : this.alW;
            if (!(typedValue == null || typedValue.type == 0)) {
                ...
                if (dimension > 0) {
                    i = MeasureSpec.makeMeasureSpec(Math.min(dimension - (this.ama.left + this.ama.right), MeasureSpec.getSize(i)), 1073741824);
                    obj = 1;
                    if (mode2 == Integer.MIN_VALUE) {
                        typedValue = obj3 == null ? this.alY : this.alZ;
                        if (!(typedValue == null || typedValue.type == 0)) {
                            if (typedValue.type == 5) {
                                dimension = (int) typedValue.getDimension(displayMetrics);
                            } else if (typedValue.type != 6) {
                            ...
                            if (dimension > 0) {
                                i2 = MeasureSpec.makeMeasureSpec(Math.min(dimension - (this.ama.top + this.ama.bottom), MeasureSpec.getSize(i2)), 1073741824);
                            }
                        }
                    }
                    ...
                    if (obj == null && mode == Integer.MIN_VALUE) {
                        typedValue2 = obj3 == null ? this.alV : this.alU;
                        if (!(typedValue2 == null || typedValue2.type == 0)) {
                            ...
                            if (dimension2 > 0) {
                                dimension2 -= this.ama.left + this.ama.right;
                            }
                            if (mode2 < dimension2) {
