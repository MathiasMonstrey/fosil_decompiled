...
abstract class HeaderBehavior<V extends View> extends ViewOffsetBehavior<V> {
    ...
    class C1100a implements Runnable {
        private final CoordinatorLayout zO;
        private final V zP;
        final /* synthetic */ HeaderBehavior zQ;

        C1100a(HeaderBehavior headerBehavior, CoordinatorLayout coordinatorLayout, V v) {
            this.zQ = headerBehavior;
            this.zO = coordinatorLayout;
            this.zP = v;
        }

        public void run() {
            if (this.zP != null && this.zQ.mScroller != null) {
                if (this.zQ.mScroller.computeScrollOffset()) {
                    this.zQ.setHeaderTopBottomOffset(this.zO, this.zP, this.zQ.mScroller.getCurrY());
                    li.m12254b(this.zP, (Runnable) this);
                    return;
                }
                this.zQ.onFlingFinished(this.zO, this.zP);
            }
        }
    }
    ...
    public boolean onInterceptTouchEvent(CoordinatorLayout coordinatorLayout, V v, MotionEvent motionEvent) {
        ...
        switch (ks.m12043a(motionEvent)) {
            case 0:
                ...
                if (canDragView(v) && coordinatorLayout.m1845e(v, x, y)) {
                    this.mLastMotionY = y;
    ...
    public boolean onTouchEvent(CoordinatorLayout coordinatorLayout, V v, MotionEvent motionEvent) {
        ...
        switch (ks.m12043a(motionEvent)) {
            case 0:
                ...
                if (coordinatorLayout.m1845e(v, (int) motionEvent.getX(), y) && canDragView(v)) {
                    this.mLastMotionY = y;
                    this.mActivePointerId = motionEvent.getPointerId(0);
                    ensureVelocityTracker();
                    break;
            ...
            case 1:
                if (this.mVelocityTracker != null) {
                    ...
                    fling(coordinatorLayout, v, -getScrollRangeForDragFling(v), 0, lg.m12076b(this.mVelocityTracker, this.mActivePointerId));
                    break;
                }
                break;
            case 2:
    ...
    int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, V v, int i, int i2, int i3) {
        ...
        if (topAndBottomOffset == e) {
            return 0;
        }
        setTopAndBottomOffset(e);
        return topAndBottomOffset - e;
    }
    ...
    final boolean fling(CoordinatorLayout coordinatorLayout, V v, int i, int i2, float f) {
        ...
        if (this.mScroller == null) {
            this.mScroller = of.s(v.getContext());
        }
        this.mScroller.fling(0, getTopAndBottomOffset(), 0, Math.round(f), 0, 0, i, i2);
        if (this.mScroller.computeScrollOffset()) {
            this.mFlingRunnable = new C1100a(this, coordinatorLayout, v);
            li.m12254b((View) v, this.mFlingRunnable);
            return true;
        }
