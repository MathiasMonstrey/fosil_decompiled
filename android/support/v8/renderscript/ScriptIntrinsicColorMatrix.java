...
public class ScriptIntrinsicColorMatrix extends ScriptIntrinsic {
    ...
    public void setAdd(Float4 float4) {
        this.mAdd.f1244x = float4.f1244x;
        this.mAdd.f1245y = float4.f1245y;
        this.mAdd.f1246z = float4.f1246z;
        this.mAdd.f1243w = float4.f1243w;
        FieldPacker fieldPacker = new FieldPacker(16);
        fieldPacker.addF32(float4.f1244x);
        fieldPacker.addF32(float4.f1245y);
        fieldPacker.addF32(float4.f1246z);
        fieldPacker.addF32(float4.f1243w);
    ...
    public void setAdd(float f, float f2, float f3, float f4) {
        ...
        this.mAdd.f1243w = f4;
        FieldPacker fieldPacker = new FieldPacker(16);
        fieldPacker.addF32(this.mAdd.f1244x);
        fieldPacker.addF32(this.mAdd.f1245y);
        fieldPacker.addF32(this.mAdd.f1246z);
        fieldPacker.addF32(this.mAdd.f1243w);
        setVar(1, fieldPacker);
    }
