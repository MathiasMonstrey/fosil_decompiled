...
public class ZoneInfoCompiler {
                ...
                if (stringTokenizer.hasMoreTokens()) {
                    ...
                    if (nextToken.startsWith("last")) {
                        ...
                        try {
                            ...
                            i = nextToken.indexOf(SimpleComparison.GREATER_THAN_EQUAL_TO_OPERATION);
                            if (i > 0) {
                                i = Integer.parseInt(nextToken.substring(i + 2));
                                parseDayOfWeek = ZoneInfoCompiler.parseDayOfWeek(nextToken.substring(0, i));
                                z3 = true;
                            } else {
                                i = nextToken.indexOf(SimpleComparison.LESS_THAN_EQUAL_TO_OPERATION);
                                if (i > 0) {
                                    i = Integer.parseInt(nextToken.substring(i + 2));
                                    parseDayOfWeek = ZoneInfoCompiler.parseDayOfWeek(nextToken.substring(0, i));
                                    z3 = false;
                    ...
                    if (stringTokenizer.hasMoreTokens()) {
                        ...
                        if (!nextToken2.equals("24:00")) {
                            ...
                            LocalDate plusMonths = i == -1 ? new LocalDate(DisplayMode.ACTIVITY, parseMonth, 1).plusMonths(1) : new LocalDate(DisplayMode.ACTIVITY, parseMonth, i).plusDays(1);
    ...
    L_0x000c:
        ...
        r8 = r0.set(r4, r1);
        r1 = r12.getOffset(r2);
        r0 = r12.getNameKey(r2);
        r10 = new java.util.ArrayList;
        r10.<init>();
        r4 = r2;
        r2 = r1;
    L_0x003b:
        r6 = r12.nextTransition(r4);
