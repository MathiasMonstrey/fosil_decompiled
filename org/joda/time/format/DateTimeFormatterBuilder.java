        ...
        public int parseInto(DateTimeParserBucket dateTimeParserBucket, CharSequence charSequence, int i) {
            ...
            while (i3 < min) {
                ...
                if (i3 != 0 || ((charAt != '-' && charAt != '+') || !this.iSigned)) {
                    ...
                    charAt = charSequence.charAt((i2 + i3) + 1);
                    if (charAt < '0') {
                        break;
                    } else if (charAt > '9') {
                        obj = obj2;
            ...
            if (i3 >= 9) {
                i4 = i2 + i3;
                i3 = Integer.parseInt(charSequence.subSequence(i2, i4).toString());
                i2 = i4;
            } else {
                int i5;
                if (obj != null) {
                ...
                try {
                    i2 += i3;
                    i3 = charSequence.charAt(i5) - 48;
                    for (i4 = i5 + 1; i4 < i2; i4++) {
                        i3 = (charSequence.charAt(i4) + ((i3 << 3) + (i3 << 1))) - 48;
                    }
                    if (obj != null) {
                        i3 = -i3;
                    }
