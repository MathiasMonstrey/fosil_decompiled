...
public class PeriodFormatterBuilder {
    ...
    static class FieldFormatter implements PeriodParser, PeriodPrinter {
        ...
        public int countFieldsToPrint(ReadablePeriod readablePeriod, int i, Locale locale) {
            ...
            if (this.iPrintZeroSetting == 4 || getFieldValue(readablePeriod) != ButtonService.TIME_STAMP_FOR_NON_EXECUTABLE_METHOD) {
                return 1;
            }
            return 0;
        }
        ...
        public int calculatePrintedLength(ReadablePeriod readablePeriod, Locale locale) {
            ...
            if (fieldValue == ButtonService.TIME_STAMP_FOR_NON_EXECUTABLE_METHOD) {
                return 0;
            }
    ...
    static class RegExAffix extends IgnorableAffix {
        private static final Comparator<String> LENGTH_DESC_COMPARATOR = new C51001();
        private final Pattern[] iPatterns;
        private final String[] iSuffixes;
        private final String[] iSuffixesSortedDescByLength;

        static class C51001 implements Comparator<String> {
            C51001() {
            }
