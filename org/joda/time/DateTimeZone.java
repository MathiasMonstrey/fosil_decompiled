...
public abstract class DateTimeZone implements Serializable {
    ...
    static final class LazyInit {
        ...
        static class C39091 extends BaseChronology {
        ...
        private static DateTimeFormatter buildFormatter() {
            return new DateTimeFormatterBuilder().appendTimeZoneOffset(null, true, 2, 4).toFormatter().withChronology(new C39091());
        }
        ...
        if (offset != offset2) {
            if (offset - offset2 < 0) {
                ...
                if (nextTransition == j - ((long) offset)) {
                    nextTransition = ButtonService.TIME_STAMP_FOR_NON_EXECUTABLE_METHOD;
                }
